...
const CORNER_SVG = `
  <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2,2 L14,2 L14,4 L4,4 L4,14 L2,14 Z" fill="#3d5270"/>
    <path d="M6,6 L10,6 L10,8 L8,8 L8,10 L6,10 Z" fill="#3d5270"/>
    <path d="M14,2 L14,6 L16,6 L16,2 Z" fill="rgba(61,82,112,0.45)"/>
    <path d="M2,14 L6,14 L6,16 L2,16 Z" fill="rgba(61,82,112,0.45)"/>
  </svg>`;
...
export function renderPoster(cfg) {
  ...
  poster.insertAdjacentHTML('beforeend', `
    <svg class="ink-wash" viewBox="0 0 900 280" xmlns="http://www.w3.org/2000/svg">
      <path d="M0,280 L0,200 Q50,160 100,180 Q150,200 200,150 Q250,100 300,130 Q350,160 400,110 Q450,60 500,90 Q550,120 600,80 Q650,40 700,70 Q750,100 800,60 Q850,20 900,50 L900,280 Z" fill="#0e1520"/>
      <path d="M0,280 L0,230 Q80,210 160,240 Q240,270 320,220 Q400,170 480,200 Q560,230 640,190 Q720,150 800,180 Q860,200 900,170 L900,280 Z" fill="#0e1520" opacity="0.5"/>
    </svg>
    <svg class="ink-splash" style="top:-20px;right:-20px;width:200px;height:200px;" viewBox="0 0 200 200">
      <circle cx="150" cy="50" r="80" fill="#0e1520"/>
      <circle cx="100" cy="20" r="40" fill="#0e1520"/>
    </svg>
    <svg class="ink-splash" style="bottom:30px;left:-30px;width:180px;height:180px;" viewBox="0 0 200 200">
      <ellipse cx="60" cy="140" rx="70" ry="50" fill="#0e1520"/>
    </svg>
  `);
